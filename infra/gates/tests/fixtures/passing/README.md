...
Gate engine passing fixture

A citizen app on the playground. Owner: owner@example.org. Sign-in is enforced by the
platform for members of `app-passing-app-users`; this code never handles a password or a token.
